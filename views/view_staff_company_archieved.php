...
$query = "SELECT * FROM company WHERE is_deleted = 1";
                            ...
                            <?php foreach ($companies as $company): ?>
                                <tr>
                                    ...
                                    <td class="align-middle action-btns">
                                        ...
                                        <button class="btn btn-warning btn-sm" data-bs-toggle="modal" data-bs-target="#deleteCompanyModal<?php echo $company['id']; ?>">
                                ...
                                <div class="modal fade" id="deleteCompanyModal<?php echo $company['id']; ?>" tabindex="-1" aria-labelledby="deleteCompanyModalLabel" aria-hidden="true">
                                    <div class="modal-dialog modal-dialog-centered">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="deleteCompanyModalLabel">Restore</h5>
                                                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                            </div>
                                            <div class="modal-body text-center">
                                                <i class="fas fa-exclamation-triangle fa-3x text-warning mb-3"></i>
                                                <h5>Are you sure you want to restore this company?</h5>
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <a href="../controllers/restore_company.php?id=<?php echo $company['id']; ?>" class="btn btn-warning">
                                                <i class="fas fa-rotate-left me-1"></i> Restore
                                                </a>
                                            </div>
                                        </div>
