...
<head>
    ...
    <title>Staff Verify Code - PWD Portal</title>
...
<div class="container">
  <div class="login-container">
    ...
    <div class="login-card">
      ...
      <form action="../controllers/verify_code.php" method="POST">
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        <?php if (isset($_SESSION['message'])): ?>
            ...
            setTimeout(function() {
                ...
                window.location.href = '../views/view_staff_login.php'; // Redirect after closing modal
