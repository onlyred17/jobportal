...
<head>
    ...
    <title>Super Admin Login - PWD Portal</title>
...
<body>
  ...
  <a href="view_super_admin_forgot_password.php">Forgot Password?</a>
</div>
  ...
  <div class="modal fade" id="successModal" tabindex="-1" aria-labelledby="successModalLabel" aria-hidden="true">
    ...
    <script>
        document.getElementById('loginForm').addEventListener('submit', function (e) {
            ...
            fetch('../controllers/super_admin_login.php', {
                method: 'POST',
                body: formData
            })
            ...
            .then(data => {
                if (data.status === 'success') {
                    ...
                    successModal.show();
                    setTimeout(() => {
                        window.location.href = '../views/view_super_admin_dashboard.php';
                    }, 2000);
                } else {
