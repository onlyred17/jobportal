...
<head>
    ...
    <title>Admin Reset Password - PWD Portal</title>
    ...
    <div class="container">
        <div class="login-container">
            ...
            <div class="login-card">
                <?php if (isset($_SESSION['message'])): ?>
                    <script>
                        document.addEventListener('DOMContentLoaded', function() {
                            ...
                            setTimeout(function() {
                                window.location.href = "../views/view_admin_login.php";
                            }, 1500);
                        });
                    </script>
                ...
                <form action="../controllers/reset_password_admin.php" method="POST">
