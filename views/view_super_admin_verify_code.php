...
<head>
    ...
    <title>Super Admin Verify Code - PWD Portal</title>
...
<div class="container">
  ...
  <div class="login-container">
    ...
    <div class="login-card">
      ...
      <form action="../controllers/verify_code_super_admin.php" method="POST">
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        <?php if (isset($_SESSION['message'])): ?>
            ...
            setTimeout(function() {
                ...
                window.location.href = '../views/view_super_admin_login.php'; // Redirect after closing modal
