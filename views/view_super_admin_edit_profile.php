<?php
include '../controllers/super_admin_edit_profile.php';
?>
<!DOCTYPE html>
<html lang="en">
<head>
            ...
            <div class="profile-card">
                ...
                <div id="editProfileFormContainer">
                    ...
                    <div class="profile-body">
                        <form id="editProfileForm" method="POST" action="../controllers/super_admin_edit_profile.php" enctype="multipart/form-data" class="form-modern animate-slide">
                            <h3 class="mb-4">Edit Your Profile</h3>

                            <!-- Profile Picture Section -->
                            <div class="mb-4 text-center">
                                <div class="profile-pic-container">
                                    <img src="<?php echo !empty($super_admin['profile_pic']) ? htmlspecialchars($super_admin['profile_pic']) : '../images/default_profile.png'; ?>" 
                                         alt="Profile Picture" 
                                         class="profile-pic1" 
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" id="editFirstName" name="firstName" class="form-control" value="<?php echo htmlspecialchars($super_admin['first_name']); ?>" required>
                            </div>

                            <div class="mb-4">
                                <label for="editLastName">Last Name</label>
                                <input type="text" id="editLastName" name="lastName" class="form-control" value="<?php echo htmlspecialchars($super_admin['last_name']); ?>" required>
                            </div>

                            <div class="mb-4">
                                <label for="editContactNumber">Contact Number</label>
                                <input type="tel" id="editContactNumber" name="contactNumber" class="form-control" value="<?php echo htmlspecialchars($super_admin['contact_number']); ?>" required>
                            </div>
