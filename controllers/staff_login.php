...
try {
    // Fetch staff details including status
    $sql = "SELECT staff_id, email, password, first_name, last_name, profile_pic, status FROM staff WHERE email = :email";
